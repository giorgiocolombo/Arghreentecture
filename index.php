...
<body>
    ...
    <section class="gallery_posts">
        <figure class="gallery_item gallery_item_1">
                <img src="img-samples/photo-1579126999978-eac334843123.jpg" alt="Gallery 1" class="gallery__img">
        </figure>
        <figure class="gallery_item gallery_item_2">
                <img src="img-samples/photo-1579160855213-a6e60979eecf.jpg" alt="Gallery 2" class="gallery__img">
        </figure>
        <figure class="gallery_item gallery_item_3">
                <img src="img-samples/photo-1579189880841-43ddba8d8efd.jpg" alt="Gallery 3" class="gallery__img">
        </figure>
        <figure class="gallery_item gallery_item_4">
                <img src="img-samples/photo-1579191748111-90d7f89fe214 (1).jpg" alt="Gallery 4" class="gallery__img">
        </figure>
        <figure class="gallery_item gallery_item_5">
                <img src="img-samples/photo-1579194044198-cdd94102ef46.jpg" alt="Gallery 5" class="gallery__img">
        </figure>
    </section>
